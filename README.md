...
# Note:
This is an experimental demo. It uses a HNS Resolver from [James](https://github.com/james-stevens)) to fetch the TXT records. When an NS is set up, it will fetch only off-chain TXT records.. It works with Handshake HNS TLDs, HNS SLDs, HNS dSLDs, ENS domains and ICANN SLDs.
